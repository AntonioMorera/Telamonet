...
<script setup>
    ...
    const { t } = useI18n() //Variable para llamar al archivo de traduccion
</script>
    ...
    <main>
        ...
        <div id="form-container">
            <form method="post">
                ...
                <RouterLink to="/" id="redirect-login">{{ t("login.noAccount") }}<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></RouterLink>
            </form>
            <div id="side-panel">
                <p id="welcome">{{ t("login.welcome") }}</p>
                <img src="/src/assets/logo/Bucafeed_logo.png" alt="">
                <p id="eslogan">{{ t("login.eslogan") }}</p>
            </div>
        </div>
    </main>
</template>
