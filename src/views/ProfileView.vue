        ...
        <div class="w-[1200px] flex flex-col">
            ...
            <section class="bg-[#15202b80] text-white flex-1">
                ...
                <div class="flex justify-end items-center p-4 mt-0">
                    <ButtonTemplate :texto="t.profile.editprofile":accion="() => console.log('editar perfil')" />
                </div>
                ...
                <div class="px-5 pb-2.5 -mt-2">
                    ...
                    <p class="nombre-usuario text-[#8b98a5] text-base my-0.5 mx-0">{{ usuario.usuarioNombre }}</p>
                    <p class="seguidores text-[#8b98a5] text-sm mt-2">
                        <span class="numero font-bold text-[#e7e9ea]">{{ usuario.seguidores }}</span> 
                        {{ t.profile.followers }} · 
                        <span class="numero font-bold text-[#e7e9ea]">{{ usuario.siguiendo }}</span>
                        {{ t.profile.following }}
                    </p>
                </div>
